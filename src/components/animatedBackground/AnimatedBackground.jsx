...
const TechSvgFromTop = styled.svg`
  position: relative;
  stroke: black;
  filter: opacity(.2) grayscale(100%);
  animation: moveToBottom 8s linear infinite;
  z-index: 0;
  width: 5rem;
  height: 5rem;
...
const TechSvgFromBottom = styled.svg`
  position: relative;
  stroke: black;
  animation: moveToTop 8s linear infinite;
  filter: opacity(.2) grayscale(100%);
  z-index: 0;
  width: 5rem;
  height: 5rem;
...
export default function AnimatedBackground() {
    return (
        <Background>
            <Tech>
                <TechSvgFromTop xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50"
                                viewBox="0 0 48 48">
                ...
                <TechSvgFromBottom xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50"
                                   viewBox="0 0 48 48">
